      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.75rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginTop: '0.35rem' }}>
            Personal developer credentials for REST API authorization and automation scripts.
          </p>
        </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.875rem' }}>
            <thead>
              <tr style={{ background: 'var(--bg-subtle)', borderBottom: '1px solid var(--bg-border)', color: 'var(--text-muted)', fontSize: '0.75rem', textTransform: 'uppercase' }}>
                <th style={{ padding: '0.85rem 1.5rem' }}>Key Name</th>
                <th style={{ padding: '0.85rem 1rem' }}>Prefix</th>
                  ...
                  <td style={{ padding: '1rem 1.5rem', textAlign: 'right' }}>
                    <button
                      onClick={() => {
                        ...
                        showToast('Token Revoked', `Revoked ${k.name}`, 'info');
                      }}
            ...
            <div>
              <div style={{ padding: '1rem', background: 'rgba(16, 185, 129, 0.1)', border: '1px solid rgba(16, 185, 129, 0.3)', borderRadius: 'var(--radius-md)', marginBottom: '1.25rem' }}>
                ...
                <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                  This secret will never be displayed again for security reasons.
                </div>
              </div>
            ...
            <form onSubmit={handleGenerate} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Scraper Backend Prod"
                  value={keyName}
